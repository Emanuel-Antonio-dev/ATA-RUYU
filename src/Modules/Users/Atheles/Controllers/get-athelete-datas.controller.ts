...
@Controller('athletes')
class GetAtheleteController {
  constructor(private readonly getAtheleteService: GetAtheleteService) {}

  @Roles(Role.CENTRAL, Role.AFFILIATE, Role.AFFILIATE_ADMIN)
  @Get(':id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Buscar atlete por ID' })
  ...
  async get(@Param('id') id: string, @Req() req: RequestWithCredentials) {
    ...
    return this.getAtheleteService.get(id,credentials);
  }
}

export { GetAtheleteController };